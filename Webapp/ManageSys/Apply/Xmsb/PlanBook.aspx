<%@ Page Title="" Language="VB" MasterPageFile="~/ManageSys/Apply/Xmsb/XmsbPage.master" AutoEventWireup="false" CodeFile="PlanBook.aspx.vb" Inherits="ManageSys_ApplyUser_PlanBook" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">                   
    <br/>
    <asp:UpdatePanel ID="upPlanBookPage" runat="server">
    <ContentTemplate >
	...
	<tr>
		...
		<td  bgcolor="#bed1eb">
            <asp:FileUpload ID="fupPlanBook" runat="server" />只能上传word2003版文档，且大小不要超过4M！<asp:Button ID="btnOk" runat="server" Text="上传附件" />
        </td>
	</tr>
    </table>
    <table style="width: 100%;">
        ...
        <tr>
            <td colspan="8">
                <div style="width: 100%">
                     <asp:GridView ID="gvPlanBook" runat="server" Width="100%" 
