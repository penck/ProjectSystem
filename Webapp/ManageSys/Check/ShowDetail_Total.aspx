<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ShowDetail_Total.aspx.vb" Inherits="ManageSys_Check_ShowDetail_Total" %>
...
<body>
    ...
    <div id="Div1" style =" height :1000px; padding:20px; position:relative">
    <table width="88%" border="0" cellspacing="0" cellpadding="0" style="text-align: center" align="center" class="t1">
        <tr>
        ...
        <tr>
            <td colspan="5">
                <table border="0" cellspacing="1" cellpadding="5" width="100%" bgcolor="#cfe6f6" align="center">
                <tr id="ctl00_ContentPlaceHolder1_wcdate">
                <td bgcolor="#F2F9FE">完成时间</td>
                <td style="background-color: white;" colSpan="2">
                    <asp:Label ID="lblPrExWcsj" runat="server" Text=""></asp:Label></td>
                </tr>
                <tr>
                <td bgcolor="#F2F9FE" colSpan="3">主要研究内容<font color="red"> </font></td></tr>
                <tr>
                ...
                <tr>
                <td bgColor="#F2F9FE" colSpan="3">预期目标<font color="red"> </font></td>
                </tr>
                <tr>
                <td style="background-color: white;" colSpan="3">
                ...
                <tr>
                <td style="width: 20%;" bgColor="#F2F9FE" rowSpan="3">项目经费账号信息 
                                </td>
