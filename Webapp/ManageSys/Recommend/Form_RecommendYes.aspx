<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Form_RecommendYes.aspx.vb" Inherits="ManageSys_Recommend_Form_RecommendYes" %>
...
<body>
    ...
    <div style =" height :10px;"></div>
        请填写推荐意见：<br />
        <asp:TextBox ID="txtPrReTjYy" runat="server" TextMode="MultiLine" Width="392px" 
